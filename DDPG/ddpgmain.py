...
if __name__ == "__main__":
    ...
    Box_position = [0.5908450974804389, 0.0754887624414724, 0.75]
    print(Box_position)
    var = 1.0
    total_rewards = []
    step_sums = []
    dep = np.load("C:/Users/VCC/Desktop/[0.5908450974804389, 0.0754887624414724, 0.75].npy")
    rgb = cv2.imread("C:/Users/VCC/Desktop/[0.5908450974804389, 0.0754887624414724, 0.75].png")
    # 主循环
    for i in range(1, MAX_EPISODES):
        ...
        while True:
            st += 1
            action = rl.choose_action(rgb, dep.reshape(1, 1, 224, 224), state)
